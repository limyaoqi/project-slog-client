...
export default function Home_Chatroom({
  ...
  return (
    <div className="flex flex-col h-[80vh] min-h-full  bg-gray-800 text-black">
    <div className="flex rounded-t-xl items-center justify-between p-4 bg-white border-b border-gray-300">
      <button
    ...
    <div className="p-4 bg-white rounded-b-xl border-t border-gray-300">
